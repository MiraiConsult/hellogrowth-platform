...
<head>
  ...
  <title>Termo de Assinatura Eletrônica</title>
  <style>
...
<body>
  ...
  <div class="section">
    ...
    <div class="info-grid">
      <div class="info-item">
        ...
        <span>${sig.patient_name || '—'}</span>
      </div>
      <div class="info-item">
        <label>E-mail</label>
        <span>${sig.patient_email || '—'}</span>
      </div>
      <div class="info-item">
        <label>Telefone</label>
        <span>${sig.patient_phone || '—'}</span>
      </div>
      <div class="info-item">
      ...
      <div class="info-item">
        ...
        <span style="font-family:monospace; font-size:12px;">${sig.ip_address || '—'}</span>
      </div>
      <div class="info-item">
        <label>ID do Registro</label>
        <span style="font-family:monospace; font-size:11px;">${sig.id}</span>
      </div>
    </div>
  </div>
  ...
  <div class="footer">
    ...
    console.error('[generate-term-pdf] Erro:', error);
