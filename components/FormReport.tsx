...
const FormReport: React.FC<FormReportProps> = ({ formId, forms, leads, onBack, supabase, userId, onLeadUpdate, onLeadDelete, initialLeadId }) => {
  ...
  // Estados para reenvio de WhatsApp de análise
...
Retorne APENAS um JSON válido (sem markdown) com:
{
  ...
  // Função de reenvio de WhatsApp de análise
                ...
                {detailSection === 'ai' && (
                  <div>
                    ...
                    <div className="mt-4 border-t border-gray-200 pt-4">
                      ...
                      <p className="text-xs text-gray-500 mb-3">
                        Envia a análise da IA via WhatsApp para o número configurado no formulário.
                        Você também pode informar um número alternativo abaixo.
                      </p>
                      <div className="flex gap-2 mb-2">
                        <input
                          type="text"
