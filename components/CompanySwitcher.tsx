      ...
      {showConfirmation && selectedCompany && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-xl max-w-sm w-full mx-4">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Trocar de Empresa</h3>
            <p className="text-gray-600 mb-6">
              Deseja trocar para a empresa <strong className="text-gray-800">{selectedCompany.company?.name}</strong>?
            </p>
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-gradient-to-r from-teal-500 to-emerald-600 text-white hover:from-teal-600 hover:to-emerald-700 transition-colors text-sm font-medium"
              >
                Confirmar
              </button>
            </div>
