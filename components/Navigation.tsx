  ...
  const navStructure: NavigationItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'report-history', label: 'Histórico de Relatórios', icon: BarChart3, requiredPlan: 'all' },
        { id: 'system-health', label: 'Saúde do Sistema', icon: Activity, requiredPlan: 'all' },
        { id: 'conversation-export', label: 'Exportar Conversas', icon: Download, requiredPlan: 'all' },
